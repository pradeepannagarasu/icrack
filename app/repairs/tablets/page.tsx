...
type iPadCategory = "all" | "ipad" | "ipad-mini" | "ipad-air" | "ipad-pro";

const categories: { id: iPadCategory; name: string }[] = [
  { id: "all", name: "All iPads" },
  { id: "ipad", name: "iPad" },
...
function filterModelsByCategory(models: typeof allTabletModels, category: iPadCategory) {
  ...
  return models.filter((model) => {
    ...
    if (category === "ipad-pro") {
      return id.includes("ipad-pro");
    } else if (category === "ipad-air") {
      return id.includes("ipad-air");
    } else if (category === "ipad-mini") {
      return id.includes("ipad-mini");
    } else if (category === "ipad") {
      // Regular iPad (not pro, air, or mini)
      return id.includes("ipad") && 
             !id.includes("ipad-pro") && 
             !id.includes("ipad-air") && 
             !id.includes("ipad-mini");
    }
    return false;
  });
}
...
export default function TabletsPage() {
  const [selectedCategory, setSelectedCategory] = useState<iPadCategory>("all");
  const filteredModels = filterModelsByCategory(allTabletModels, selectedCategory);
