...
export async function generateMetadata() {
  return {
    title: "Laptop Repairs | iCrack",
    description: "Expert laptop repair services for all major brands including MacBook, Dell, HP, Lenovo, and more.",
  };
}

export default function LaptopsPage() {
  const laptopBrands = getBrandsByCategory("laptops");
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-lg md:text-xl text-neutral-600 max-w-3xl mx-auto">
            Expert laptop repair services for all major brands. Fast turnaround times and quality parts.
          </p>
        </div>
