...
const samsungModels = brandsData.brands
  .find((b) => b.id === "samsung")
  ?.models.filter((m) => !m.id.includes("tab")) || [];
...
export default function SamsungRepairsPage() {
  return (
    <div className="pt-20 lg:pt-[176px]">
      ...
      <DeviceSelectionGrid
        title="Select Your Samsung Device"
        subtitle="Choose your Samsung model to see available repair options and pricing"
